"""
Message-based scoring (v2): per-run sent/received/broadcast counts, a
weighted score, and a per-agent-per-second normalized score so runs with
different agent counts/durations are comparable.

Usage: python score_runs_v2.py [--db runs.db] [--last N]
"""
...
def main():
    ...
    ap.add_argument("--last", type=int, default=5, help="Only show the N most recent runs.")
    args = ap.parse_args()
